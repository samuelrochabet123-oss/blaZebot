...
# O motor compartilha a conexão do sheets_db e será inicializado
# pelo collector na chegada da primeira rodada.
print("ℹ️ Motor de estratégias será inicializado pelo collector na primeira rodada.", flush=True)
